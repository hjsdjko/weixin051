...
public class ShiwuleixingController {
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShiwuleixingEntity shiwuleixing, 
		HttpServletRequest request){
        EntityWrapper<ShiwuleixingEntity> ew = new EntityWrapper<ShiwuleixingEntity>();
    ...
    public R query(ShiwuleixingEntity shiwuleixing){
		...
		return R.ok("查询食物类型成功").put("data", shiwuleixingView);
    }
    ...
    public R info(@PathVariable("id") Long id){
		...
		shiwuleixing = shiwuleixingService.selectView(new EntityWrapper<ShiwuleixingEntity>().eq("id", id));
