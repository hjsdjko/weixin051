	...
	<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ffffff","height":"100%"}'>
		<form :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","background":"#ffffff","display":"block","height":"auto"}' class="app-update-pv">
			...
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","alignItems":"center","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0px","background":"#e7fefc","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				...
				<input :style='{"border":"0px solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"8rpx","flex":"1","background":"#ffffff00","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' :disabled="ro.nianling" v-model="ruleForm.nianling" placeholder="年龄"></input>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","alignItems":"center","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0px","background":"#e7fefc","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				...
				<input :style='{"border":"0px solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"8rpx","flex":"1","background":"#ffffff00","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' :disabled="ro.xingbie" v-model="ruleForm.xingbie" placeholder="性别"></input>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","alignItems":"center","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0px","background":"#e7fefc","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">分析时间</view>
				<input :style='{"border":"0px solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"8rpx","flex":"1","background":"#ffffff00","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-model="ruleForm.fenxishijian" placeholder="分析时间" @tap="toggleTab('fenxishijian')"></input>
			</view>
			...
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","alignItems":"center","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0px","background":"#e7fefc","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">分析简介</view>
				<textarea :style='{"border":"0px solid #eeeeee","padding":"24rpx 24rpx 24rpx 24rpx","margin":"0 0 0 0","color":"#000000","borderRadius":"8rpx","flex":"1","background":"none","fontSize":"28rpx","height":"240rpx"}' v-model="ruleForm.fenxijianjie" placeholder="分析简介"></textarea>
			</view>
			...
			<view :style='{"padding":"12rpx 0 12rpx 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","borderWidth":"0 0 0px 0","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","fontWeight":"500"}' class="title">分析详情</view>
                <xia-editor ref="editor" :style='{"minHeight":"300rpx","border":"0px solid #efefef","padding":"20rpx","color":"#666666","borderRadius":"8rpx 0 0 8rpx","background":"#e7fefc","width":"100%","height":"auto"}' v-model="ruleForm.fenxixiangqing" placeholder="分析详情" @editorChange="fenxixiangqingChange"></xia-editor>
			</view>
		...
		<w-picker mode="dateTime" step="1" :current="false" :hasSecond="false" @confirm="fenxishijianConfirm" ref="fenxishijian" themeColor="#333333"></w-picker>
	</view>
</view>
</template>
...
<script>
	...
	export default {
		...
		async onLoad(options) {
            this.ruleForm.fenxishijian = this.$utils.getCurDateTime();
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`fenxibaogao`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					...
					if(o=='fenxijianjie'){
					this.ruleForm.fenxijianjie = obj[o];
					this.ro.fenxijianjie = true;
					continue;
					}
					if(o=='fenxixiangqing'){
					this.ruleForm.fenxixiangqing = obj[o];
					this.ro.fenxixiangqing = true;
					continue;
					}
					if(o=='fenxishijian'){
		...
		methods: {
            fenxixiangqingChange(e) {
                this.ruleForm.fenxixiangqing = e
            },
			styleChange() {
				this.$nextTick(()=>{
			...
			async yonghuzhanghaoChange (e) {
				...
				if(res.data.nianling){
					this.ruleForm.nianling = res.data.nianling
				}
				if(res.data.xingbie){
					this.ruleForm.xingbie = res.data.xingbie
				}
			},
			...
			// 日长控件选择日期时间
			fenxishijianConfirm(val) {
				console.log(val)
				this.ruleForm.fenxishijian = val.result;
				this.$forceUpdate();
			},
...
//跨表计算判断
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`fenxibaogao`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`fenxibaogao`, this.ruleForm);
						}else{
							await this.$api.add(`fenxibaogao`, this.ruleForm);
						}
